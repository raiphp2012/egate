...
function productaction()
{
  ...
  // $this->form_validation->set_rules('model_name','Product TYPE','required|trim');
  ...
  $this->form_validation->set_rules('m_name','Model Name','required|trim');
  $this->form_validation->set_rules('m_number','Model Number','required|trim');
  $this->form_validation->set_rules('d_tech','Display Technology','required|trim');
  $this->form_validation->set_rules('b_requried','Battery Required','required|trim');
  $this->form_validation->set_rules('dis_requried','Display Resulation','required|trim');
  $this->form_validation->set_rules('bat_include','Battery Include','required|trim');
  $this->form_validation->set_rules('w_item','Item  Weight','required|trim');
    ...
    if ($this->upload->do_upload('pro_feat_image')) 
    {
     ...
     if(!empty(array_filter($_FILES['pro_gallery']['name']))){
      ...
      $product=array(
        ...
        'd_tech'=>$this->input->post('d_tech'),
        'b_requried'=>$this->input->post('b_requried'),
        'dis_requried'=>$this->input->post('dis_requried'),
        'bat_include'=>$this->input->post('bat_include'),
        'w_item'=>$this->input->post('w_item'),
