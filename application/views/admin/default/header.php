			...
			<nav class="navbar header-navbar pcoded-header">
				<div class="navbar-wrapper">
					<div class="navbar-logo">
							...
							<img class="img-fluid" src="<?php echo base_url('assets/images/logo.png');?>" alt="Egate" />
						
						<a class="mobile-menu" id="mobile-collapse" href="#">
							<i class="feather icon-menu icon-toggle-right" style="display: none;"></i>
						</a>
							...
							<li class="header-notification">
								<div class="dropdown-primary dropdown">
									...
									<ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
										...
										<li>
											<div class="media">
												<img class="img-radius" src="<?php echo base_url(); ?>assets/admin/files/assets/images/avatar-4.jpg" alt="Generic placeholder image">
