...
<html>
	...
	<div class="ab_banner">
			<img src="<?php echo base_url('assets/images/i-srs.jpg');?>" width="100%">
			<div class="ab_text">
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-12 text-center fh5co-heading">
					<span></span>
					<h2>X-series projectors.</h2>
					<p>This truly compact model boasts a big screen image allowing you to enjoy the real-life 3D movie experience.
            ...
            <div class="unorder">
			  <div class="col-md-6">
					<ul>
							<li>&#8226;Range of DLP projectors to choose from</li>
							<li>&#8226;Built in battey* 
 
							</li>
							<li>&#8226;Small yet powerful
			  ...
			  <div class="col-md-6">
					...
					<ul>
							<li>&#8226;Native Resolution - 480 to 720p

							</li>
							<li>&#8226;Screen Size - 304 to 762 cm (120 " to 300")

							</li>
							<li>&#8226;Full 3D + 2D to 3D Converter (Active)
			...
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(<?php echo base_url('assets/');?>images/i_series/X12.png);">
							<div class="inner">
								<p>
									<a href="<?php echo base_url('home/product_details');?>" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="<?php echo base_url('home/product_details');?>" class="icon"><i class="icon-eye"></i></a>
								</p>
							</div>
						</div>
						<div class="desc">
							<h3><a href="<?php echo base_url('home/product_details');?>">X12</a></h3>
							<span class="price">INR. 30,000</span>
						</div>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(<?php echo base_url('assets/');?>images/i_series/x9.png);">
						...
						<div class="desc">
							<h3><a href="<?php echo base_url('home/product_details');?>">X9</a></h3>
							<span class="price">INR. 30,000</span>
						</div>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(<?php echo base_url('assets/');?>images/i_series/X6-a.png);">
							<div class="inner">
								<p>
									<a href="<?php echo base_url('home/product_details');?>" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="<?php echo base_url('home/product_details');?>" class="icon"><i class="icon-eye"></i></a>
						...
						<div class="desc">
							<h3><a href="<?php echo base_url('home/product_details');?>">X 6</a></h3>
							<span class="price">INR. 30,000</span>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(<?php echo base_url('assets/');?>images/i_series/X6-m.png);">
							<div class="inner">
								<p>
									<a href="<?php echo base_url('home/product_details');?>" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="<?php echo base_url('home/product_details');?>" class="icon"><i class="icon-eye"></i></a>
						...
						<div class="desc">
							<h3><a href="<?php echo base_url('home/product_details');?>">X6 M</a></h3>
							<span class="price">INR. 30,000</span>
						</div>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						...
						<div class="desc">
							<h3><a href="<?php echo base_url('home/product_details');?>">X6 A</a></h3>
							<span class="price">INR. 30,000</span>
						</div>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(<?php echo base_url('assets/');?>images/i_series/x3-s.png);">
							<div class="inner">
								<p>
									<a href="<?php echo base_url('home/product_details');?>" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="<?php echo base_url('home/product_details');?>" class="icon"><i class="icon-eye"></i></a>
						...
						<div class="desc">
							<h3><a href="<?php echo base_url('home/product_details');?>">X3</a></h3>
							<span class="price">INR. 30,000</span>
						</div>
					</div>
				</div>
				...
				<div class="row">
						<div class="col-md-4 text-center animate-box">
							<div class="product">
								<div class="product-grid" style="background-image:url(<?php echo base_url('assets/');?>images/i_series/x3-m.png);">
									<div class="inner">
										<p>
											<a href="<?php echo base_url('home/product_details');?>" class="icon"><i class="icon-shopping-cart"></i></a>
											<a href="<?php echo base_url('home/product_details');?>" class="icon"><i class="icon-eye"></i></a>
								...
								<div class="desc">
									<h3><a href="<?php echo base_url('home/product_details');?>">X3 M</a></h3>
									<span class="price">INR. 30,000</span>
								</div>
							</div>
						</div>
						<div class="col-md-4 text-center animate-box">
							<div class="product">
								<div class="product-grid" style="background-image:url(<?php echo base_url('assets/');?>images/i_series/x3-a.png);">
									<span class="sale">Sale</span>
									<div class="inner">
										<p>
											<a href="<?php echo base_url('home/product_details');?>" class="icon"><i class="icon-shopping-cart"></i></a>
								...
								<div class="desc">
									<h3><a href="<?php echo base_url('home/product_details');?>">X3 A</a></h3>
									<span class="price">INR. 30,000</span>
								</div>
							</div>
						</div>
						<!-- <div class="col-md-4 text-center animate-box">
							<div class="product">
								<div class="product-grid" style="background-image:url(images/i_series/i9-1_standar.png);">
									<div class="inner">
										<p>
								...
								<div class="desc">
									<h3><a href="single.html">X-series</a></h3>
									<span class="price">INR. 30,000</span>
								</div>
							</div>
						</div> -->
